package com.example.chayan.weatherapp;
...
import com.example.chayan.weatherapp.Helper.Helper;
import com.example.chayan.weatherapp.Model.OpenWeatherMap;
import com.example.chayan.weatherapp.Common.Common;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private class GetWeather extends AsyncTask<String,Void,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.contains("ERROR: NOT fount city")){
            ...
            txtLastUpdate.setText(String.format("Last Updae: %s",Common.getDateNow()));
